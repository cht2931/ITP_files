...
function loop() {
  ...
  if (client.connected && publishing) {
    ...
    // publish to broker:
    document.getElementById('MovingRect').style.animation = "slide 2s infinite";
...
function onDisconnect() {
  ...
  document.getElementById('MovingRect').style.animation = "stop 2s infinite";
}
